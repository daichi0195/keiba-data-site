...
export default function DistanceTrendExplanation() {
  ...
  const explanationPoints = [
    '短距離〜マイルと中長距離〜長距離の複勝率を比較し、得意な距離傾向を判定しています。'
  ];
            ...
            <div className="explanation-content">
              ...
              <div style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid #e2e8f0', fontSize: '0.85rem', color: '#475569', lineHeight: '1.5' }}>
                ...
                <ul style={{ margin: '0.5rem 0 0 1.5rem', paddingLeft: 0, fontSize: '0.85rem' }}>
                  <li>短距離〜マイルの複勝率が中長距離〜長距離より5%以上高い：短距離が得意</li>
                  <li>短距離〜マイルの複勝率が中長距離〜長距離より2%以上高い：やや短距離が得意</li>
                  <li>複勝率の差がほぼない：互角</li>
                  <li>中長距離〜長距離の複勝率が短距離〜マイルより2%以上高い：やや長距離が得意</li>
                  <li>中長距離〜長距離の複勝率が短距離〜マイルより5%以上高い：長距離が得意</li>
                </ul>
              </div>
            </div>
          </div>
