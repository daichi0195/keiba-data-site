      ...
      <main>
        <article>
          ...
          <section id="characteristics" aria-label="調教師特徴">
            <BarChartAnimation>
              <div className="characteristics-box">
                ...
                {/* 得意な脚質傾向（2分化） */}
                {trainer.running_style_trends && trainer.running_style_trends.length > 0 && trainer.characteristics.running_style_trend_position && (
                  <div className="gauge-item">
                    <div className="gauge-header">
                    ...
                    <div className="gauge-track">
                      <div className="gauge-indicator" style={{ left: `${(trainer.characteristics.running_style_trend_position - 1) * 25}%` }}></div>
                      <div className="gauge-horse-icon" style={{ left: `${(trainer.characteristics.running_style_trend_position - 1) * 25}%` }}>🏇</div>
                    </div>
                    <div className="gauge-labels">
                      <span>逃げ・先行が得意</span>
                      <span>互角</span>
                    ...
                    <div className="gauge-result">
                      {trainer.characteristics.running_style_trend_position === 1 && '逃げ・先行が得意'}
                      {trainer.characteristics.running_style_trend_position === 2 && 'やや逃げ・先行が得意'}
                      {trainer.characteristics.running_style_trend_position === 3 && '互角'}
                      {trainer.characteristics.running_style_trend_position === 4 && 'やや差し・追込が得意'}
                      {trainer.characteristics.running_style_trend_position === 5 && '差し・追込が得意'}
                    </div>
                    ...
                    <div className="running-style-place-rate-detail">
                      ...
                      <div className="running-style-chart">
                        {trainer.running_style_stats.map((style) => {
                          // アイコンマッピング
          ...
          <section id="highlights-section" aria-label="注目ポイント">
            <HighlightsSection
              trainer_stats={trainer.course_stats}
            />
          </section>
